/* 
   Reads 7 temperatures from the user and shows which are above and which are below the average of the 7 temperatures
 */
...
public class ArrayOfTemperatures
{
   public static void main (String[]args)
   {
      ...
      System.out.println("Have a nice week."); nm,jkuiz
   }
}